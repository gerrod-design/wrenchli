...
export default function Contact() {
  ...
  const submitConsumer = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const isRateLimit = errStr.includes("rate limit");
      toast({
  ...
  return (
    <main className="pb-[60px] md:pb-0">
      <SEO
        title="Contact Us"
        description="Get in touch with Wrenchli. Questions about auto repair quotes, shop partnerships, or anything else — we're here to help."
        path="/contact"
      />
      {/* Hero */}
