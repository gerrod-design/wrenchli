...
export default function ReferralPackage() {
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      doc.text("This is an AI-assisted estimate. Final diagnosis and pricing should be confirmed by a qualified technician.", margin, y + 4);
  ...
  return (
    <main className="pb-[60px] md:pb-0">
      <SEO
        ...
        description={`View diagnosis and repair estimate for ${vehicleStr || "vehicle"}.`}
        path={`/referral/${token}`}
      />
      ...
      <div className="container-wrenchli max-w-4xl py-8 space-y-6">
        ...
        {data.chat_summary && (
          <div className="rounded-xl border border-border bg-card p-6 space-y-3">
            ...
            >
              <h2 className="font-heading text-lg font-bold flex items-center gap-2">
                <FileText className="h-5 w-5 text-accent" /> AI Diagnostic Chat Summary
              </h2>
        ...
        <div className="rounded-xl border border-amber-500/20 bg-amber-500/5 p-4 text-center text-xs text-muted-foreground">
          ...
          <p>
            This is an AI-assisted diagnosis and cost estimate. Final diagnosis and pricing should be confirmed through hands-on inspection by a qualified technician. Actual repair costs may vary based on vehicle condition and shop rates.
          </p>
        </div>
