        ...
        <div className="container-wrenchli text-center relative">
          <SectionReveal>
            ...
            <h1 className="mt-6 font-heading text-3xl font-extrabold leading-tight md:text-5xl lg:text-6xl">
              Understand Your Repair. Trust the Fix.
            </h1>
            ...
            <p className="mt-3 max-w-2xl mx-auto text-lg text-primary-foreground/70 leading-relaxed md:text-xl">
              A repair you don't understand shouldn't feel like a gamble. Wrenchli gives you a clear picture of what's wrong and what it should cost, so you and your shop can agree on the right fix at the right price.
            </p>
