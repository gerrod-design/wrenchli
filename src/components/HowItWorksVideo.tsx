...
const diySteps = [
  ...
  { step: 4, icon: ShoppingCart, title: "Order Parts & Tools", desc: "See exactly what you need with prices from Amazon, O'Reilly, and RockAuto — plus loaner tool tips." },
...
const shopSteps = [
  ...
  { step: 5, icon: Store, title: "Take It to Any Qualified Shop", desc: "Bring your assessment to an independent shop you trust — you'll walk in knowing what's likely wrong and what it should cost." },
];
  ...
  return (
    <section className="section-padding bg-background">
      <div className="container-wrenchli">
        ...
        {/* Replay button — only after walkthrough completes */}
        {hasPlayed && (
          <SectionReveal>
            <div className="mt-6 flex justify-center">
              ...
              >
                <RotateCcw className="mr-1.5 h-3.5 w-3.5" /> Watch Again
              </Button>
            </div>
          </SectionReveal>
        )}
