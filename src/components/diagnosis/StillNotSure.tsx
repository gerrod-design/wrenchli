  ...
  return (
    <div className="mt-8 rounded-2xl border border-border bg-card p-6 md:p-8 text-center">
      ...
      <p className="mt-2 text-sm text-muted-foreground max-w-lg mx-auto leading-relaxed">
        That's completely okay — vehicle problems can be tricky to pinpoint without seeing it in person. Take it to a qualified local shop for a full hands-on inspection.
      </p>
      <Button
        size="lg"
