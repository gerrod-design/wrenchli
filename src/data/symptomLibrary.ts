...
export const symptomLibrary: SymptomEntry[] = [
  ...
  },
  {
    ...
    description: "The check engine light can be triggered by hundreds of different issues, from a loose gas cap to a serious engine problem. Without reading the OBD-II trouble code stored in your vehicle's computer, it's impossible to know the specific cause.",
    ...
    specialNote: "We strongly recommend scanning your vehicle with an OBD-II scanner to read the specific code. This gives you a much more accurate symptom assessment. Many auto parts stores will scan your vehicle for free.",
  },
  {
  ...
  },
  {
    ...
    description: "Unusual noises can come from many vehicle systems. The type of noise and when it occurs are the best clues to identifying the source. Without hearing the noise in person, we can suggest common causes, but a technician's ears-on inspection is the best path to an accurate assessment.",
    ...
    specialNote: "Noise-based assessments are especially difficult without a physical inspection. We strongly recommend having a qualified technician listen to and inspect the vehicle.",
  },
];
