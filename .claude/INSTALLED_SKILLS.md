...
For any significant decision, run Strategy → Operations → CEO Check → Engineering Check → Brand/Marketing compliance.

Strategy determines what. Operations determines how. CEO and Engineering gate the execution. Brand and Marketing govern the output.
